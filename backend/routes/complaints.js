...
// Create a new complaint (Student only) - WITH FILE UPLOAD
// router.post('/', [
//   auth,
//   requireStudent,
//   uploadMultiple, // Add multer middleware for file uploads
//   body('category').isIn(['electrical', 'plumbing', 'carpentry', 'internet', 'sanitation', 'other']),
//   body('title').trim().notEmpty().withMessage('Title is required'),
//   body('description').trim().notEmpty().withMessage('Description is required'),
//   body('location').trim().notEmpty().withMessage('Location is required')
...
//     auth,
//     requireStudent,
//     // REMOVED: uploadMultiple, // ← Remove this line
//     // REMOVED: handleUploadError, // ← Remove this line
//     body('category').isIn(['electrical', 'plumbing', 'carpentry', 'internet', 'sanitation', 'other']),
//     body('title').trim().notEmpty().withMessage('Title is required'),
//     body('description').trim().notEmpty().withMessage('Description is required'),
//     body('location').trim().notEmpty().withMessage('Location is required')
...
//       // Use the images directly from req.body (they're base64 encoded from frontend)
...
//         priority: priority || 'medium',
//         urgency: urgency || 'moderate',
//         images: images || [] // Use the images array directly
//       });
...
// ✅ Get statistics (moved ABOVE :id to avoid CastError)
