...
// // Student login - NO OTP VERIFICATION REQUIRED
...
// // Admin login - NO OTP VERIFICATION REQUIRED
...
// // Student registration with email verification (OTP only for registration)
...
// // Admin registration with email verification (OTP only for registration)
...
// // Verify OTP for both student and admin (Only for registration)
...
// // Resend OTP (Only for registration)
...
// //     const emailSent = await sendVerificationEmail(user.email, otp, user.name, 'student');
...
// // Forgot password - UPDATED to use email instead of studentId and mobile
// exports.forgotPassword = async (req, res) => {
//   try {
//     const errors = validationResult(req);
//     if (!errors.isEmpty()) {
